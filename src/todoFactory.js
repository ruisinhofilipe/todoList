...
// //     const standardTodo = elementFactory('div', { class: 'todosName', 'data-index': index }, undefined,
...
// //         elementFactory('button', { class: 'removeTodo' }, 'x')
// //     );
// //     todoArray[currentProjectIndex].push(todo.title);
...
//         const todoName = elementFactory('div', { class: 'todosName', 'data-index': index }, undefined,
...
//             elementFactory('button', { class: 'removeTodo', onclick: removeTodo() }, 'x')
//         );
